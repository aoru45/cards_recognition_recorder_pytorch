...
#engine = pyttsx3.init()  
detected_cards = []
heads = ["heart","spade","club","diamond"]
tails = [str(i) for i in range(2,11)]
tails.extend(["a","j","q","k"])
detected_times = {
    head + "_" + tail :0 for head in heads for tail in tails
}
def detect(
        cfg,
        data_cfg,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-cfg', type=str, default='data/cards.data', help='coco.data file path')
